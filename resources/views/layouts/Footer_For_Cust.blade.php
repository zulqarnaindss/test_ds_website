                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 col-lg-8 order-lg-1 row-pdng-right-zero align-items-stretch">
                        ...
                        <div class="content-box">
                            ...
                            <p>Discover how our round-the-clock, top-rated support team can provide the perfect resource from our in-house pool of 300+ well-trained professionals, specialising in Dynamics 365 Customization services in the UK</span></p>
                            <div class="mt-4">
            ...
            <div class="faq-container-new">
                <div class="accordionfaq">
                    <div class="accordion-item">
                        <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">What Does the D365 Customization Service Entail?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>The D365 customization service enables tailoring Dynamics 365 Customer Engagement (on-premises) to your specific business requirements. You can adapt entities, fields, forms, views, dashboards, workflows, and more through various tools and components.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">How Can D365 Customization Service Benefit My Business?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>D365 customization service enhances user experience, productivity, and efficiency within your Dynamics 365 Customer Engagement (on-premises) application. Additionally, it allows for extending functionality and integrating with other services and applications to meet diverse business needs.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What Tools and Components Does D365 Customization Service Offer?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>D365 customization service encompasses a comprehensive suite of WYSIWYG designer and editor tools including app designer, entity designer, form designer, view designer, dashboard designer, workflow designer, and more. Moreover, it supports customization through code and scripts via web resources, plugins, custom actions, and custom workflow activities.</p>

                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">How Does Dynamics Stream Ensure Smooth Implementation of D365 Customization Services?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Explore how Dynamics Stream streamlines the implementation process to seamlessly integrate tailored solutions into your Dynamics 365 Customer Engagement (on-premises) platform, ensuring optimal performance and user satisfaction.</p>
                        </div>
                    </div>
                </div>
            </div>
