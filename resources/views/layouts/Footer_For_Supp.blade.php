                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 col-lg-8 order-lg-1 row-pdng-right-zero align-items-stretch">
                        ...
                        <div class="content-box">
                            ...
                            <p>Discover how our round-the-clock, top-rated support team can provide the perfect resource from our in-house pool of 300+ well-trained professionals, specialising in Dynamics 365 Functional Support services in the UK</span></p>
                            <div class="mt-4">
    ...
    <div class="container-lg">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="d-flex-new text-center mtop-3rem-new flex-wrap justify-content-between align-items-center">
            ...
            <div class="faq-container-new">
                <div class="accordionfaq">
                    <div class="accordion-item">
                        <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">What Does Dynamics 365 Support Service Encompass?
                            </span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Dynamics 365 support service comprises a suite of options and resources designed to assist customers in resolving technical issues, accessing self-help portals, and connecting with experts and peers for guidance.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">What Support Plans are Available for Dynamics 365 Customers?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Dynamics 365 customers can choose from three support plans: Standard, Professional Direct, and Unified Enterprise. Each plan offers varying levels of service, response time, and cost to cater to different business needs.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What Are the Advantages of Professional Direct and Unified Enterprise Support Plans?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Professional Direct and Unified Enterprise support plans provide faster response times, priority handling, escalation management, technical webinars, advisory services, proactive services, and more. Unified Enterprise additionally offers on-demand workshops, remote diagnostics and reporting, onsite services, and enhanced solutions.</p>

                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What Are the Levels of D365 Support Service?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>D365 support service offers three levels: Standard, Professional Direct, and Unified Enterprise. Standard, included with any Dynamics 365 purchase, suits businesses operating simpler environments or working with full-service partners. Professional Direct, at $9 per user/month, is ideal for businesses requiring faster response times and expert advisory services. Starting at $50,000/year, Unified Enterprise provides comprehensive end-to-end support for organisations needing assistance across all Microsoft technologies.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What Are the Key Benefits of D365 Support Service?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>D365 support service ensures you maximise your Dynamics 365 investment by providing reliable, timely, and expert technical support. Depending on your support plan, you can access online training, webinars, proactive services, service delivery management, priority handling, escalation management, advisory services, and more. The D365 support service guarantees that your applications remain up-to-date, secure, and compliant.</p>
                        </div>
                    </div>
		...
		<div class="row">
			<div class="col-xl-3 col-md-6 mb-3">
				...
				<ul class="footer-nav">
					...
					<li><a href="#">Microsoft Customer Service</a></li>
			...
			<div class="col-xl-3 col-md-6 mb-3">
				...
				<ul class="footer-nav">
					...
					<li><a href="/dynamics-365-support">Support & Service Level Agreements</a></li>
			...
			<div class="col-xl-3 col-md-6 mb-3">
				...
				<ul class="footer-nav">
					...
					<li><a href="/request-demo">Connect</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-xl-12">
				<div class=" text-center flex-wrap align-items-center">
					<img src="{{asset('newassets')}}/images/brand/microsoft-logo.png" class="micro-solu-logo img-fluid mr-right-logos" alt="Microsoft Logo" width="160" />
					<img src="{{asset('newassets')}}/images/brand/shopify-logo.png" class="img-fluid mr-right-logos" alt="Shopify Logo" width="160" />
					<img src="{{asset('newassets')}}/images/brand/micro-gold-logo.png" class="micro-solu-logo img-fluid mr-right-logos" alt="Microsoft Gold Logo" width="160" />
					<img src="{{asset('newassets')}}/images/brand/iso-img.png" class="img-fluid mr-right-logos" alt="Microsoft Gold Logo" width="160" />
					<img src="{{asset('newassets')}}/images/brand/hubspot-logo.png" class="img-fluid" alt="Hubspot Logo" width="160" />
				</div>
			</div>
		</div>
			...
			<div class="row ">
				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mb-4">
					<div class="footer-card">
						<h5 class="mb-4 fw-bold-h">Dubai - United Arab Emirates</h5>
						<h5 class=" lh-base">Head Office</h5>
						<h5 class="mb-3 lh-base">1803 The Metropolis Tower <br />Business Bay | Downtown <br /> <br /></h5>
				...
				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mb-4">
					<div class="footer-card">
						<h5 class="mb-4 fw-bold-h">United states of America</h5>
						<h5 class=" lh-base">Branch Office</h5>
						<h5 class="mb-3 lh-base">2000 Cropsey Ave <br />Brooklyn - New York <br />Post Code 11214</h5>
						<h5 class="">For Sales, Support & Enquiries</h5>
				...
				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mb-4">
					<div class="footer-card">
						<h5 class="mb-4 fw-bold-h">Pakistan</h5>
						<h5 class="mb-4"></h5>
						<h5 class=" lh-base">Branch Office</h5>
						<h5 class="mb-3 lh-base">Johar Town <br />Lahore <br /> <br /></h5>
						<h5 class="">For Sales, Support & Enquiries</h5>
						<h5 class=""><a class="anch-color-and-deco" href="mailto:info@dynamicsstream.com">info@dynamicsstream.com</a> </h5>
					</div>
				</div>
				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mb-4">
					<div class="footer-card">
						<h5 class="mb-4 fw-bold-h">United Kingdom</h5>
						<h5 class="mb-4"></h5>
						<h5 class=" lh-base">Branch Office</h5>
						<h5 class="mb-3 lh-base">Stembridge Road <br />London <br /><br></h5>
						<h5 class="">For Sales, Support & Enquiries</h5>
						<h5 class=""><a href="tel:+44 7376 588837" class="anch-color-and-deco">+44 7376 588837</a> </h5>
					</div>
				</div>
			</div>
		</div>
