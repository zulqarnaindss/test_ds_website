        ...
        <div class="px-xl-5">
            <div class="row-card-resource row-card-resource-implementation-bg" id="Resource-augmentation">
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-7 order-lg-1 align-items-stretch">
                        <div class="">
                            <img src="http://127.0.0.1:8000/newassets/images/contact-m.webp" class="img-fluid CTA-img-st mobile-blocks" alt="Support Image" width="400">
                        </div>

                        <div class="content-box">
                            <h3 class="res-augmnt-he mb-4">Ready to Transform Your Business in the Digital Landscape?</h3>
                            <p>Discover how our round-the-clock, top-rated support team can provide the perfect resource from our in-house pool of 300+ well-trained professional, specialising in<span style="font-weight: 500;"> Dynamics 365 implementation consulting services in the UK</span>.</p>
                            <div class="mt-4">
                                <a href="/contact-us" class="btn contct-us-btn-pdgn btn-outline-theme mb-2">Reporting</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5 txt-right align-items-stretch order-lg-2">
                        <img src="http://127.0.0.1:8000/newassets/images/support-img.webp" class="img-fluid CTA-img-st mobile-none" alt="Support Image" width="400">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 d-flex align-items-stretch mb-3">
                    ...
                    <div class="Test-for-new-serv-card">
                        <div class="">
                            <div class="">
                                <img src="{{asset('assets')}}/images/new-services-pages/cortec-done.webp" class="img-fluid mb-3" width="200" />
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 d-flex align-items-stretch mb-3">
                    ...
                    <div class="Test-for-new-serv-card mrg-tp-testim">
                        <div class="">
                            <div class="">
                                <img src="{{asset('assets')}}/images/new-services-pages/khiara-done.webp" class="img-fluid mb-3" width="200" />
                            </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="blog-card">
                    <div>
                        ...
                        <p class="mb-5 m-font-p excerpt">{{$blogss->excerpt }}</p>
                    </div>
                    <div>
                        <a href="{{ route('blogs_detail', ['slug' =>$blogss->slug]) }}" class="text-dark text-decoration-none">Read the blog <i class="bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="faq-container-new">
                <div class="accordionfaq">
                    <div class="accordion-item">
                        <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">What is Dynamics 365 support service?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Dynamics 365 support service is a set of options and resources that help customers resolve technical issues, access self-help portals, and connect with experts and peers.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-2" aria-expanded="false"><span class="accordion-title">What are the different support plans available for Dynamics 365 customers?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>There are three support plans for Dynamics 365 customers: Standard, Professional Direct, and Unified Enterprise. Each plan offers different levels of service, response time, and cost.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What are the benefits of Professional Direct and Unified Enterprise support plans?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Professional Direct and Unified Enterprise support plans offer faster response times, priority handling, escalation management, technical webinars, advisory services, proactive services, and more. Unified Enterprise also offers on-demand workshops, remote diagnostics and reporting, onsite services, and enhanced solutions.</p>

                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What are the different levels of d365 support service?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>There are three levels of d365 support service: Standard, Professional Direct, and Unified Enterprise. Standard is included with any Dynamics 365 purchase and is best for businesses operating a simple environment or using a full-service partner. Professional Direct costs $9 per user/month and is best for businesses with a continuously operating production environment requiring faster response times and access to experts for advisory and escalation services. Unified Enterprise is a custom plan that starts at $50,000/year and is best for businesses that need comprehensive end-to-end support for the entire organization, covering all Microsoft technologies.</p>

                        </div>
                    </div>
                    <div class="accordion-item">
                        <button id="accordion-button-3" aria-expanded="false"><span class="accordion-title">What are the benefits of d365 support service?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>d365 support service helps you get the most out of your Dynamics 365 investment by providing you with reliable, timely, and expert technical support. You can also take advantage of online training, webinars, proactive services, service delivery management, priority handling, escalation management, advisory services, and more, depending on your support plan level. d365 support service also ensures that your Dynamics 365 applications are always up to date, secure, and compliant.</p>
                        </div>
                    </div>
        ...
        <div class="row g-0 align-items-center">
            <div class="col-lg-4 col-md-6 align-items-stretch">
                <div class="contact-card">
                    <img src="{{asset('newassets')}}/images/home/contact-form-img.webp" class="img-fluid" alt="" />
                </div>
            </div>
            <div class="col-lg-8 col-md-6 align-items-stretch">
                <div class="contact-card2">
                    <div>
                        <div class="">
                            <h6 class="mrg-b-2rem mt-4">Our consultants make sure that you get the right solution & care</h6>
                        </div>
                        <form class="contact-form" id="contactForm" action="/contact-form" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control bg-white" id="phone" name="phone" placeholder="Number Format +44 7376 588837" required />
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <textarea name="message" class="form-control bg-white" rows="3" placeholder="Please explain your project/ requirement & our consultant will connect with you with relevant solution."></textarea>
                                </div>
                                <div class="col-md-12">
		...
		<div class="row">
			<div class="col-xl-3 col-md-6 mb-3">
				...
				<ul class="footer-nav">
					...
					<li><a href="/microsoft-dynamics-365/human-resources">Human resources- Microsoft Dynamics 365</a></li>
					<li><a href="/microsoft-dynamics-365/crm">Microsoft Sales</a></li>
			...
			<div class="col-xl-3 col-md-6 mb-3">
				...
				<ul class="footer-nav">
					...
					<li><a href="#Resource-augmentation">Resource Augmentations Of Microsoft-Dynamics Business Applications</a></li>
		...
		<div class="row align-items-center">
			<div class="col-xl-12">
				...
				<div class="text-center mb-4">
					<a href="https://www.linkedin.com/company/dynamicsstream.com" target="_blank" class="btn btn-pdng-for-scl social-footr-icns-uk">
						<svg xmlns="http://www.w3.org/2000/svg" class="m-width-for-social" width="47" height="40" viewBox="0 0 87 80" fill="none">
					...
					<a href="https://www.youtube.com/@dynamicsstream" target="_blank" class="btn btn-pdng-for-scl social-footr-icns-uk">
						<svg xmlns="http://www.w3.org/2000/svg" width="60" class="m-width-for-social" height="60" viewBox="0 0 110 100" fill="none">
					...
					<a href="https://www.instagram.com/dynamics365specialists/" target="_blank" class="btn btn-pdng-for-scl social-footr-icns-uk">
						<svg xmlns="http://www.w3.org/2000/svg" width="49" class="m-width-for-social" height="46" viewBox="0 0 89 86" fill="none">
					...
					<a href="https://www.facebook.com/dynamicsstream" target="_blank" class="btn btn-pdng-for-scl social-footr-icns-uk">
						<svg xmlns="http://www.w3.org/2000/svg" class="m-width-for-social" width="40" height="40" viewBox="0 0 77 76" fill="none">
