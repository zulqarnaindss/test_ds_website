        ...
        <div class="px-xl-5">
            <div class="row-card-resource row-card-resource-implementation-bg" id="Resource-augmentation">
                <div class="row align-items-end">
                    ...
                    <div class="col-xl-5 col-lg-5 text-center order-lg-2">
                        <img src="http://127.0.0.1:8000/newassets/images/support-img.png" class="img-fluid" alt="Support Image" width="400">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="faq-container-new">
                <div class="accordionfaq">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <p>The analysis phase is the first and most important phase of D365 implementation. It involves defining the scope, goals, and requirements of the project, as well as identifying the current business processes and pain points.</p>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            ...
                            <ol class="ol-style-tp">
                                ...
                                <li>D365 Life cycle Services (LCS)</li>
