...
<!--Section Starts-->
<!-- <section class="relevant-sec bg-dark py-4" style="--bs-bg-opacity: .9;">
	<div class="container-fluid px-4">
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<h6 class="text-white small mb-0">Blogs, Relevant Topics & White-papers:</h6>
			</div>
			<div class="col-lg-7 col-md-6 dspl-fl-blgs">



				<div class="cover-wrappernds">
					<div id="client-logosnds" class="owl-carousel text-center">
						@foreach($blogsndss as $blogss)
						<div class="itemnds">
							<div class="client-innersnds">
								<div class="div-for-slider-ind-boxsnds box-shadowzznds">
									<p class="text-white small mb-0 pdgn-bl-new-ft"><a href="{{ route('blogs_detail', ['slug' =>$blogss->slug]) }}" class="blgs-anch-ft"> {{$blogss->title}}</a></p>
			...
			<div class="col-lg-2 col-md-6">
				<p class="text-white mb-0 small "><a href="/blogs" class="blgs-anch-ft bordr-btn-blog">Read More Blogs</a> </p>
			</div>
		</div>
	</div>
</section> -->
