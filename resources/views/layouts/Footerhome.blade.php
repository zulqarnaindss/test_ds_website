			...
			<div class="col-lg-4 col-md-6 d-flex align-items-stretch">
				<div class="blog-card">
					<div>
						...
						<p class="mb-4 excerpt">{{$blogss->excerpt }}</p>
					</div>
					<div>
...
<section class="service-sec-new py-5">
	<div class="container px-md-5">
		<div class="owl-carousel" id="service_carousel">
			...
			<div class="item text-center"><a href="/microsoft-dynamics-365-wholesale-and-distribution" class="service-link3">Trading & Distribution</a></div>
			...
			<div class="item text-center"><a href="/microsoft-dynamics-365-for-retail" class="service-link3">Retail</a></div>
			<div class="item text-center"><a href="javascript:void(0);" class="service-link3">Food delivery Apps</a></div>
			<div class="item text-center"><a href="/microsoft-dynamics-365-for-financial-services" class="service-link3">Financial</a></div>
			<div class="item text-center"><a href="/microsoft-dynamics-365-for-public-sector" class="service-link3">Public Administration</a></div>
			...
			<div class="item text-center"><a href="/microsoft-dynamics-365-for-manufacturing" class="service-link3">manufacturing</a></div>
