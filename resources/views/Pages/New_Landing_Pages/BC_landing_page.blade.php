                    ...
                    <div class="col-xl-12 col-md-12  align-items-stretch">
                        <div class="sect-sec-card">
                            <div class="sect-sec-cbc-div">
                                ...
                                <div class="opcity-redu-circl" style="width: 100px;height: 100px;top: 261px;z-index: -1;left: 140px;border-radius: 50%;position: absolute;transform: rotate(269deg);transform-origin: 0 0;border: 2.92px #96D586 dotted;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12 col-md-12 align-items-stretch">
