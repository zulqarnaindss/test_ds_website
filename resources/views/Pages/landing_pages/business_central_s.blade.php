@extends('main_4_landing_us')
@section('title', 'Microsoft Dynamics 365 Solution')
@section('meta_description', 'Start & Grow Your Business with Microsoft Dynamics 365 a powerful platform that offers a range of solutions for businesses of all sizes and industries in USA.')
                        ...
                        <div class="modal-land">
                            ...
                            <div class="modal__content">
                                <div class="formbold-main-wrapper-land">
                                    ...
                                    <form method="POST" class="lacontactFormusa1" action="{{ route('business-central-usa-landing-contact-form') }}">
                                            @csrf
                                ...
                                <div class="content">
                                    <div class="formbold-main-wrappers for-new-la-d">
                                        <div class="formbold-form-wrappers">
                                            ...
                                            @endif
                                            <form method="POST" class="lacontactFormusa2" action="{{ route('business-central-usa-landing-contact-form') }}">
                                            @csrf
...
<section class="slide  kenBurns">
    ...
    <div class="background" style="background-color:#DBE3E2"></div>
</section>
<section class="slide  kenBurns">
    <div class="content">
        <div class="container">
