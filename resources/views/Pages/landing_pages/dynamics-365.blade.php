...
@section('title', 'Microsoft Dynamics 365')
            ...
            <div class="wrapss">
                <ul class="grid grid-85 equal ae-2 fromCenter  u-l-m-landing" data-equal-collapse-width="767">
                    <li class="col-7-12 col-tablet-1-2 col-phablet-1-1 ae-3">
                        <h2 class="heading-landing-fisrt-bc"> Start & <span class="for-m-non-colr" style="color:#18E4CB ;"> Grow </span>Your <span class="for-m-non-colr" style="color:#18E4CB ;">Business</span> with <span class="for-m-non-colr" style="color:#18E4CB ;">Microsoft Dynamics 365</span></h2>
                        <p class="p-landing-first-sect-bc">Microsoft Dynamics 365 or Microsoft ERP is a cloud-based platform that is tailored to your industry and business needs. It helps you manage your finances, sales, marketing, service, or human resources, and seamlessly streamline your business operations, improve customer experience, and drive growth.</p>
                    ...
                    <li class="col-5-12 col-tablet-1-2 col-phablet-1-1 ae-3 mrgn-la-form-li">
                        <div class="modal-land">
                            <h2 class="modal__title-land">Start your ERP journey!</h2>
                            <div class="modal__content">
                                <div class="formbold-main-wrapper-land">
                                    <div class="formbold-form-wrapper-land">
                                        <form method="POST" class="lacontactForm" action="{{ route('submit-form') }}">
                                            @csrf
                                ...
                                <div class="content">
                                    <div class="formbold-main-wrappers for-new-la-d">
                                        <div class="formbold-form-wrappers">
                                            ...
                                            @endif
                                            <form method="POST" class="lacontactForm2" action="{{ route('submit-form') }}">
                                                @csrf
...
<section class="slide  kenBurns">
    <div class="content">
        <div class="containers">
            <div class="wrapss">
                <h2 class="heading-th-lan-bc mrgn-t-l-new">Capabilities of Microsoft Dynamics 365</h2>
            </div>
            <!-- Card -->
            <div class="card_outerbc">
                ...
                <div class="cardbc">
                    <div class="contentbc">
                        ...
                        <p class="copybc">Manage your finances, sales, service, inventory, projects, and more from a single platform that integrates seamlessly with other Microsoft products and services.</p>
                    </div>
                </div>
                <div class="cardbc">
                    <div class="contentbc">
...
<section class="slide  kenBurns">
    <div class="content">
        <div class="containers">
            <div class="wrapss">
                <h2 class="heading-th-lan-bc-ser">Our Services</h2>
                <div class="land-bc-sect-6-di">
                    <div class="containeer-for-bc-land-sect-6">
                        <div class=" for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            ...
                            <p>Our Microsoft Dynamics 365 experts evaluate your processes and develop an implementation strategy for adoption.</p>
                        </div>
                        <div class="for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            <div class="tick-img-land-bc-di">
                            ...
                            <p>Our team of professionals takes care of the complete Microsoft Dynamics 365 implementation process with a guaranteed smoother transition.</p>
                        </div>
                        <div class=" for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            <div class="tick-img-land-bc-di">
                            ...
                            <p>We consider your business's requirements and provide a tailored, customized plan for Microsoft Dynamics ERP & CRM implementation.</p>
                        </div>
                    </div>
                    <div class="containeer-for-bc-land mrgn-for-land-bc-forth">
                        <div class="for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            ...
                            <p>You will be on your path toward integrated operations with Dynamics 365 in no time with our team of Microsoft Certified consultants.</p>
                        </div>
                        <div class="for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            <div class="tick-img-land-bc-di">
                            ...
                            <p>We are available 24/7 during and after implementation to ensure that you are overwhelmed with our response.</p>
                        </div>
                        <div class="for-land-bc-box-sect-6 for-bc-land-third-sect-6">
                            <div class="tick-img-land-bc-di">
                            ...
                            <p>We are the finest in migration and upgradation services. Upgrade from Dynamics AX, GP, or NAV GP to the most recent version of Microsoft Dynamics 365 to improve overall operations efficiency and performance.</p>
                        </div>
                    </div>
                ...
                <div class="cover-wrapper">
                    <div id="client-logos" class="owl-carousel text-center">
                        ...
                        <div class="item">
                            <div class="client-inners">
                                <div class="div-for-slider-ind-boxs box-shadowzz">
                                    <img src="{{ asset('assets') }}/images/business-central/new/industries-icons/public-administration.webp" alt="Kinderhotel Aschauerhof" height="150" style="margin: auto;" width="150">
                        ...
                        <div class="item">
                            <div class="client-inners">
                                <div class="div-for-slider-ind-boxs box-shadowzz">
                                    <img src="{{ asset('assets') }}/images/business-central/new/industries-icons/food-delivery-services.webp" alt="Kinderhotel Aschauerhof" height="150" style="margin: auto;" width="150">
        ...
        <div class="container">
            <div class="wrapss">
                <div class="why-c-se-new-for-bc-di">
                    ...
                    <p class="p-land-why-bc">Dynamics Stream is a Microsoft Dynamics 365 Solutions Provider Partner with
                        years of
                        expertise working with diverse clients and industries. We can assist you in locating solutions that
                ...
                <div class="land-bc-sect-why-di">
                    <ul class="grid grid-85 equal ae-2 fromCenter text-cnts" data-equal-collapse-width="767">
                        ...
                        <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-3 pdng-lef-for-new-la">
                            ...
                            <h3 class="heading-green-why"><img src="{{ asset('assets') }}/images/business-central/upd/w-c-u-tick.webp" alt="" style="width: 8%;vertical-align:middle" height="" width=""> We are Affordatble</h3>
                            ...
                            <div class="box-for-pricing-new-for online-box-new-for-la">
                                <div>
                                    <div class="for-border-prici">
                                        <ul class="grid grid-85 equal ae-2 fromCenter" data-equal-collapse-width="767">
                                            <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-3 ">
                                                <p class="list-p-online list-p-mar"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Free
                                                    MailBox - 50 GB</p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> No
                                                    Minimum Users </p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> 40
                                                    Hours
                                                    Onboarding &
                                                    training </p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" />
                                                    Managing
                                                    Receivables
                                                </p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" />
                                                ...
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Work
                                                    with Dimensions
                                                </p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" />
                                                    Create
                                                ...
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Post
                                                    Transactions
                                            ...
                                            <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-3 ">
                                                ...
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" />
                                                    ...
                                                    Costs and
                                                    Income </p>
                                                <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Use
                                                    Item
                                                    Charges to
                                    ...
                                    <ul class="grid grid-85 equal ae-2 fromCenter u-l-m mrg-prici" data-equal-collapse-width="767">
                                        <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-3">
                                            <p class="list-p-online list-para-mar">Everything in Essential Plan,
                                                plus:</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Minimum 5
                                                users </p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> 100 Hours
                                                Onboarding & training</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Assembly
                                                Management</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Service
                                                Management</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> General
                                                Business Planning</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Project
                                                Management</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" /> Production
                                                Planning</p>
                                            <p class="list-p-online"><img class="done-image-bc" src="https://dynamicsstream.com/storage/new-home-images/pricing/tick.webp" alt="" />
                                                Manufacturing </p>
                                        </li>
        ...
        <div class="containers">
            <div class="wraps">
                ...
                <div class="main-footer-section">
                    <ul class="grid grid-85 equal ae-2 fromCenter" data-equal-collapse-width="767">
                        <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-3">
                            <h2 class="footer-hs mrn-for-firt-h">Start your ERP journey!</h2>
                        </li>
                                ...
                                <div class="modal__content">
                                    <div class="formbold-main-wrapper-land-f">
                                        <div class="formbold-form-wrapper-land-f txt-lef-new-365">
                                            ...
                                            {{ \Session::forget('success') }}
                                            @endif
                                            <form method="POST" class="lacontactForm3" action="{{ route('submit-form') }}">
                                                @csrf
                                                <ul class="grid grid-85 equal ae-2 fromCenter" data-equal-collapse-width="767">
                                                    <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 ae-3">
                            ...
                            <div class="mrg-left-for" style="display: flex;">
                                ...
                                <div class="anc-di-for-new-bc">
                                    <a href="https://wa.me/971526510534" target="_blank">
                                        <p class=" contact-para-footer">
                                            <i class="fa fa-whatsapp mo-fon-new" aria-hidden="true" style="font-size: 24px;
    color: white;
    border-radius: 4px;
    padding: 2px;
    background: #25d366;"></i>
                            ...
                            <div class="dsp-for-flx">
                                <ul class="lsdt new-mrt-lan  social-icn-margn">
                                    <div class="social h-p-for-new-bc ">
                                        <a href="https://www.youtube.com/@dynamicsstream" target="_blank" class="youtb"><img src="{{asset('assets')}}/images/footer-icon/youtube.webp" class="yutub" alt=""></a>
                                        <a href="https://www.linkedin.com/company/dynamicsstream.com" target="_blank" class="linkd "> <img src="{{asset('assets')}}/images/footer-icon/linkedin.webp" class="linkin" alt="">
                                        </a>
                                        <a href="https://www.instagram.com/dynamics365specialists/" target="_blank" class="faceb"><img src="{{asset('assets')}}/images/footer-icon/insta.webp" class="linkin" alt=""></a>
                                    </div>
                                </ul>
                                <div class="qr-footer-f-lan">
                                    @foreach($footersolution as $footersolutions)
                                    <img src="{{ asset('/storage/'.$footersolutions->image_1)}}" class="qrcode-image new-mrgn-for-landing-d" alt="">
                                    @endforeach
                                </div>
                            </div>
...
<div id="delayedPopup" class="delayedPopupWindow">
    ...
    <div class="">
        <div class="form-logo-di">
            <img src="{{ asset('assets') }}/images/home/form-logo.webp" alt="dynamics logo" class="form-logo-popup">
        </div>
        <h2 class="tel-he-new-pop">Start your ERP journey!</h2>
        <div class="contents">
            <div class="formbold-main-wrappers-whl">
                <div class="formbold-form-wrappers-whl">
                    @if(\Session::has('success'))
                    <div class="alert alert-success ">{{ \Session::get('success') }}</div>
                    {{ \Session::forget('success') }}
                    @endif
                    <form method="POST" action="{{ route('submit-form-popup') }}">
                        @csrf
                        <div class="formbold-mb-5-ups-whl"><label for="fullname"></label> <input id="name" name="name" type="text" class="formbold-form-input-ups-whl" placeholder="Full Name" /></div>
                        <div class="formbold-mb-5-ups-whl"><label for="company"></label> <input id="cname" name="company" type="text" class="formbold-form-input-ups-whl" placeholder="Company Name" /></div>
                        <div class="formbold-mb-5-ups-whl">
                            <label for="email"></label> <input id="emailwhl" onkeyup="validateEmailwhl()" name="email" placeholder="Email Address*" type="email" class="formbold-form-input-ups-whl" required />
                            <span id="error-messagewhl" class="error-message"></span>
                        </div>
                        <div class="formbold-mb-5-ups-whl"><label for="phone"></label> <input name="phone" type="tel" class="formbold-form-input-ups-whl phonez" minlength="9" maxlength="17" placeholder="Phone Number*" required /></div>
                        <div class="formbold-mb-5s-whl"> <label for="solutions"></label>
                            <select id="solution" class="formbold-form-inputs-whl" name="solutions">
                                <option disabled="disabled" selected="selected" value="">Choose a
                                    Solution</option>
                                <option class="optons-whl" value="Dynamics 365 Business Central">
                                    Dynamics 365 Business Central
                                </option>
                                <option value="Dynamics 365 Finance and Supply Chain">Dynamics 365
                                    Finance and Supply Chain
                       ...
                       <div class="algn-centr-btn">
                            <button class="formbold-btns-whl">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
