...
@section('title', $pricingplan->meta_title_for_contact_one)
@section('meta_description', $pricingplan->meta_description_for_contact_one)
@section('meta_keywords', $pricingplan->meta_keyword_for_contact_one)
@endforeach
@section('contents')
                                ...
                                <div class="formbold-form-wrapper">
                                    <form id="contactForm" action="{{ route('submit-pricing') }}" method="POST">
                                        ...
                                        <div class="formbold-mb-5"><label class="formbold-form-label"
                                            ...
                                            <input id="email" onkeyup="validateEmail()" name="email" type="email" class="formbold-form-input"
                                        ...
                                        <div class="formbold-mb-5">
                                            <label class="formbold-form-label" for="phone">Industries
                                            </label>
                                            <select id="industry" class="formbold-form-input" name="industry"
                                                required="">
                                        ...
                                        <div class="formbold-mb-5"><label class="formbold-form-label">Plan</label>
                                            <input type="text" name="plan" class="formbold-form-input" placeholder=""
                                                value="Basic Plan" readonly style="cursor:not-allowed">
                                        </div>
