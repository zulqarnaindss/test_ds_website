...
@section('title', $pricingplan->meta_title_for_contact_three)
@section('meta_description', $pricingplan->meta_description_for_contact_three)
@section('meta_keywords', $pricingplan->meta_keyword_for_contact_three)
@endforeach
@section('contents')
                                    ...
                                    <form id="contactForm" action="{{ route('submit-pricing') }}" method="POST">
                                        ...
                                        <div class="formbold-mb-5"><label class="formbold-form-label" for="phone">Mobile
                                            ...
                                            <input id="phone" name="mobile_number" type="number"
                                                class="formbold-form-input" placeholder="phone number" required />
                                        ...
                                        <div class="formbold-mb-5"><label class="formbold-form-label">Plan</label>
                                            <input type="text" name="plan" class="formbold-form-input" placeholder=""
                                                value="Premium Plan" readonly style="cursor:not-allowed">
                                        </div>
